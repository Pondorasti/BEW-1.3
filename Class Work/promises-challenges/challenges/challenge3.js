...
async function greetAndUppercaseAndSpace(name) {
  greeting = await greet(name)
  uppercasedGreeting = await uppercaser(greeting)
  uppercasedSpacedGreeting = await spacer(uppercasedGreeting)
  return uppercasedSpacedGreeting
}
...
result = greetAndUppercaseAndSpace("Alex")
result
  .then((result) => {
    console.log(result)
  })
